...
A full list of contributors can be found on [https://github.cms.gov/DSACMS/party-planning-website/graphs/contributors](https://github.cms.gov/DSACMS/party-planning-website/graphs/contributors).
...
<!--
## Community
The party-planning-website team is taking a community-first and open source approach to the product development of this tool. We believe government software should be made in the open and be built and licensed such that anyone can download the code, run it themselves without paying money to third parties or using proprietary software, and use it as they will.
